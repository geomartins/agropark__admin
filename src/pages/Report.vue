    ...
    <q-pull-to-refresh @refresh="refresh">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 ">
          ...
          <template>
            <div class="filterUserContainer shadow-1 q-pb-xl" key="filterUserContainer " v-if="preloader.tableNamesWithLink == ''" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-9 col-xs-12 col-sm-9 col lg-12">
                    <div class="q-mt-md q-mr-md q-ml-md q-mb-sm">
                      <div class="row">
                        <q-skeleton height="300px" width="100%" square />
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    async main() {
      ...
      this.seoMetaTitle("Report Module");

      //Event Bus
      EventBus.$emit("page_title", "Report Module");
